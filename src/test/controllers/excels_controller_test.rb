...
class ExcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create excel" do
    assert_difference('Excel.count') do
      post excels_url, params: { excel: { day: @excel.day, name: @excel.name, place: @excel.place, title: @excel.title } }
    end
  ...
  test "should update excel" do
    patch excel_url(@excel), params: { excel: { day: @excel.day, name: @excel.name, place: @excel.place, title: @excel.title } }
